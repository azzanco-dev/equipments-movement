...
export const translations = {
  ar: {
    ...
    // Residence permit extraction (/extracting)
    extractingTitle: 'استخراج بيانات الاقامة',
    extractingSubtitle: 'ارفع صورة واضحة، راجع البيانات، ثم اختر منصات النشر',
    extractingNotAuthorized: 'غير مصرح',
    extractingAdminOnly: 'هذه الصفحة متاحة للادمن فقط',
    extractingChooseImage: 'اختر صورة الاقامة',
    extractingImageHint: 'JPEG، PNG، WEBP — حد 10 ميجابايت',
    extractingKilobytes: 'كيلوبايت',
    extractingPreviewAlt: 'معاينة صورة الاقامة',
    extractingRead: 'قراءة الصورة',
    extractingExtractedSection: 'البيانات المستخرجة',
    extractingEmploymentSection: 'بيانات التوظيف والنشر',
    extractingTargetsSection: 'منصات النشر',
    extractingSubmit: 'مراجعة وتاكيد النشر',
    extractingReviewNotice:
      'راجع البيانات المستخرجة واكمل الحقول المطلوبة قبل النشر',
    extractingPublishDone: 'اكتملت محاولة النشر. راجع نتيجة كل منصة ادناه',
    extractingFixFields: 'راجع الحقول المعلمة قبل النشر',
    extractingSelectTarget: 'اختر منصة واحدة على الاقل',
    extractingDatePlaceholder: 'يوم-شهر-سنة',
    extractingSelectGender: 'اختر الجنس',
    extractingMale: 'ذكر',
    extractingFemale: 'انثى',
    extractingLanguageAr: 'العربية',
    extractingLanguageEn: 'English',
    extractingFieldFullNameAr: 'الاسم بالعربي',
    extractingFieldFullNameEn: 'الاسم بالانجليزي',
    extractingFieldIdNumber: 'رقم الهوية',
    extractingFieldDateOfBirth: 'تاريخ الميلاد',
    extractingFieldResidenceExpiry: 'تاريخ انتهاء الاقامة',
    extractingFieldNationality: 'الجنسية',
    extractingFieldOccupation: 'المهنة',
    extractingFieldEmail: 'بريد مستخدم ERPNext',
    extractingFieldEmployeeNumber: 'رقم الموظف',
    extractingFieldMobile: 'رقم الجوال',
    extractingFieldGender: 'الجنس',
    extractingFieldLanguage: 'اللغة',
    extractingFieldCompany: 'الشركة في ERPNext',
    extractingFieldEmploymentType: 'نوع التوظيف',
    extractingFieldDepartment: 'القسم',
    extractingFieldDateOfJoining: 'تاريخ المباشرة',
    extractingFieldCtc: 'الراتب (CTC)',
    extractingTargetCurrentSystem: 'النظام الحالي',
    extractingTargetErpnext: 'ERPNext',
    extractingStepUser: 'المستخدم',
    extractingStepEmployee: 'الموظف',
    extractingStatusCreated: 'تم الانشاء',
    extractingStatusExisting: 'موجود مسبقا',
    extractingStatusPartial: 'اكتمل جزئيا',
    extractingStatusSkipped: 'لم يتم اختياره',
    extractingStatusFailed: 'فشل',
    extractingProviderStatus: 'رمز استجابة الخدمة',
    extractingInvalidRequired: 'هذا الحقل مطلوب',
    extractingInvalidIdNumber: 'رقم الهوية يجب ان يكون من 5 الى 20 رقما',
    extractingInvalidEmail: 'صيغة البريد غير صحيحة',
    extractingInvalidMobile:
      'رقم الجوال من 7 الى 15 رقما، ويمكن ان يبدا بعلامة +',
    extractingInvalidCtc: 'الراتب رقم بحد اقصى منزلتين عشريتين',
    extractingInvalidDate: 'التاريخ غير صحيح. استخدم الصيغة يوم-شهر-سنة',
    extractingInvalidLanguage: 'اللغة غير مدعومة',
    extractingErrUnauthorized: 'انتهت الجلسة. سجل الدخول مرة اخرى',
    extractingErrForbidden: 'هذه العملية متاحة للادمن فقط',
    extractingErrServiceUnavailable:
    ...
    extractingErrImageTooLarge:
      'حجم الصورة يجب ان يكون اكبر من صفر ولا يزيد عن 10 ميجابايت',
    extractingErrOcrNotConfigured:
      'خدمة قراءة الصور غير مفعلة: مفتاح Mistral غير موجود في اعدادات الخادم',
    extractingErrOcrAuth:
      'رفضت خدمة Mistral مفتاح الربط. راجع قيمة MISTRAL_API_KEY على الخادم',
    extractingErrOcrRateLimited:
      'تم تجاوز حد الطلبات او انتهى الرصيد في خدمة Mistral. انتظر قليلا ثم حاول مرة اخرى',
    extractingErrOcrImageRejected:
      'رفضت خدمة Mistral الصورة. جرب صورة اوضح او بصيغة مختلفة',
    extractingErrOcrTimeout:
      'استغرقت قراءة الصورة اكثر من 30 ثانية. حاول مرة اخرى او استخدم صورة اصغر',
    extractingErrOcrProviderUnavailable:
      'خدمة Mistral متوقفة مؤقتا من جهتها. حاول بعد قليل',
    extractingErrOcrConnection:
      'تعذر اتصال الخادم بخدمة Mistral. تحقق من اتصال الخادم بالانترنت',
    extractingErrOcrInvalidResponse:
      'ردت خدمة Mistral برد غير مفهوم. حاول مرة اخرى',
    extractingErrOcrNoData:
      'لم يتم العثور على بيانات في الصورة. تاكد انها صورة اقامة واضحة وكاملة',
    extractingErrOcrFailed:
    ...
    extractingErrErpRequiredFields: 'اكمل حقول ERPNext المطلوبة',
    extractingErrErpNotConfigured: 'اعدادات ERPNext غير مكتملة على الخادم',
    extractingErrErpFieldMapping: 'اعدادات حقول ERPNext غير صالحة',
    extractingErrErpEmployeeLookup: 'تعذر التحقق من الموظف في ERPNext',
    extractingErrErpUserLookup: 'تعذر التحقق من المستخدم في ERPNext',
    extractingErrErpUserCreate: 'تعذر انشاء المستخدم في ERPNext',
    extractingErrErpEmployeeCreate: 'تعذر انشاء الموظف في ERPNext',
    extractingErrErpUserConflict:
      'الموظف مرتبط بمستخدم ERPNext مختلف ويحتاج مراجعة',
    extractingErrErpEmployeeUpdate: 'تعذر تحديث بيانات الموظف في ERPNext',
    extractingErrErpMetadata: 'تعذر قراءة اعدادات موظف ERPNext',
    extractingErrErpReferenceLookup: 'تعذر التحقق من قوائم ERPNext',
    extractingErrErpGender: 'قيمة الجنس غير موجودة في ERPNext',
    extractingErrErpCompany: 'اسم الشركة غير موجود في ERPNext',
    extractingErrErpEmploymentType: 'نوع التوظيف غير موجود في ERPNext',
  ...
  en: {
    ...
    // Residence permit extraction (/extracting)
    extractingTitle: 'Residence permit extraction',
    extractingSubtitle:
      'Upload a clear photo, review the data, then choose where to publish',
    extractingNotAuthorized: 'Not authorized',
    extractingAdminOnly: 'This page is available to admins only',
    extractingChooseImage: 'Choose the residence permit photo',
    extractingImageHint: 'JPEG, PNG, WEBP — up to 10 MB',
    extractingKilobytes: 'KB',
    extractingPreviewAlt: 'Residence permit preview',
    extractingRead: 'Read photo',
    extractingExtractedSection: 'Extracted data',
    extractingEmploymentSection: 'Employment and publishing data',
    extractingTargetsSection: 'Publish to',
    extractingSubmit: 'Review and publish',
    extractingReviewNotice:
      'Review the extracted data and complete the required fields before publishing',
    extractingPublishDone:
      'Publishing finished. Check the result for each platform below',
    extractingFixFields: 'Fix the highlighted fields before publishing',
    extractingSelectTarget: 'Choose at least one platform',
    extractingDatePlaceholder: 'DD-MM-YYYY',
    extractingSelectGender: 'Choose gender',
    extractingMale: 'Male',
    extractingFemale: 'Female',
    extractingLanguageAr: 'العربية',
    extractingLanguageEn: 'English',
    extractingFieldFullNameAr: 'Arabic name',
    extractingFieldFullNameEn: 'English name',
    extractingFieldIdNumber: 'ID number',
    extractingFieldDateOfBirth: 'Date of birth',
    extractingFieldResidenceExpiry: 'Residence permit expiry',
    extractingFieldNationality: 'Nationality',
    extractingFieldOccupation: 'Occupation',
    extractingFieldEmail: 'ERPNext user email',
    extractingFieldEmployeeNumber: 'Employee number',
    extractingFieldMobile: 'Mobile number',
    extractingFieldGender: 'Gender',
    extractingFieldLanguage: 'Language',
    extractingFieldCompany: 'ERPNext company',
    extractingFieldEmploymentType: 'Employment type',
    extractingFieldDepartment: 'Department',
    extractingFieldDateOfJoining: 'Date of joining',
    extractingFieldCtc: 'Salary (CTC)',
    extractingTargetCurrentSystem: 'Current system',
    extractingTargetErpnext: 'ERPNext',
    extractingStepUser: 'User',
    extractingStepEmployee: 'Employee',
    extractingStatusCreated: 'Created',
    extractingStatusExisting: 'Already exists',
    extractingStatusPartial: 'Partially completed',
    extractingStatusSkipped: 'Not selected',
    extractingStatusFailed: 'Failed',
    extractingProviderStatus: 'Service response code',
    ...
    extractingErrUnauthorized: 'Your session has ended. Sign in again',
    extractingErrForbidden: 'This action is available to admins only',
    extractingErrServiceUnavailable:
      'The server is not configured for this action. Check the Supabase settings on the server',
    extractingErrNetwork:
    ...
    extractingErrOcrNotConfigured:
      'Photo reading is not enabled: the Mistral key is missing from the server settings',
    extractingErrOcrAuth:
      'Mistral rejected the API key. Check MISTRAL_API_KEY on the server',
    extractingErrOcrRateLimited:
      'The Mistral request limit or credit was exceeded. Wait a moment and try again',
    extractingErrOcrImageRejected:
      'Mistral rejected the photo. Try a clearer photo or a different format',
    extractingErrOcrTimeout:
      'Reading the photo took more than 30 seconds. Try again or use a smaller photo',
    extractingErrOcrProviderUnavailable:
      'The Mistral service is temporarily down on their side. Try again shortly',
    extractingErrOcrConnection:
      'The server could not reach Mistral. Check the server internet connection',
    extractingErrOcrInvalidResponse:
      'Mistral sent a response that could not be read. Try again',
    extractingErrOcrNoData:
      'No data was found in the photo. Make sure it is a clear, complete residence permit',
    extractingErrOcrFailed:
      'An unexpected error occurred while reading the photo. Try again',
    extractingErrInvalidPayload:
      'The submitted data is invalid. Check the fields and try again',
    ...
    extractingErrErpUserCreate: 'Could not create the user in ERPNext',
    extractingErrErpEmployeeCreate: 'Could not create the employee in ERPNext',
    extractingErrErpUserConflict:
      'The employee is linked to a different ERPNext user and needs review',
    extractingErrErpEmployeeUpdate: 'Could not update the employee in ERPNext',
    extractingErrErpMetadata: 'Could not read the ERPNext employee settings',
