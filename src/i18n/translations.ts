...
export const translations = {
  ar: {
    ...
    ownershipStatus: 'تصنيف الملكية',
    ownershipState: 'حالة الملكية',
    lessorRequiredForOwnership: 'اختيار المؤجّر مطلوب لهذا التصنيف.',
    missingLessor: 'مؤجّر غير محدد',
    owned: 'مملوكة',
    rented: 'مستأجرة',
  ...
  en: {
    ...
    ownershipStatus: 'Ownership Classification',
    ownershipState: 'Ownership Status',
    lessorRequiredForOwnership: 'A lessor is required for this classification.',
    missingLessor: 'Lessor not specified',
    owned: 'Owned',
    rented: 'Rented',
