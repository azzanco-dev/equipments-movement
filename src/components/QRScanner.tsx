      ...
      >
        ...
        >
          ...
          <button
            ...
            className="btn-ghost p-1.5 rounded-lg text-xl leading-none"
          >
            ×
          </button>
        </div>
        <div className="p-6 space-y-3">
          <div
            id="qr-reader"
            className="w-full rounded-xl overflow-hidden bg-gray-100 dark:bg-gray-800 min-h-[200px] flex items-center justify-center"
          >
            {!scanning && (
