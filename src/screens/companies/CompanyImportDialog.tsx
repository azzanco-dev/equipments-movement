...
export interface CompanyImportDialogProps {
  ...
  /** The currently loaded page of companies, used for the local duplicate
...
/** Moved as-is from the legacy `AdminCompanies` screen. */
  ...
  const handleFileSelect = async (file: File) => {
    ...
    try {
      ...
      const existingAr = new Set(
        existingCompanies.map((c) => c.name_ar.toLowerCase()),
      )
      const existingEn = new Set(
        existingCompanies.map((c) => c.name_en.toLowerCase()),
      )
