...
export function AdminLessors() {
  ...
  function openEdit(l: Lessor) {
    setEditing(l)
    setName(l.name)
    setContactPerson(l.contact_person ?? '')
    ...
    <div className="space-y-4">
      ...
      {loading ? (
        ...
        <div className="card text-center py-12">
          <p className="text-muted">{t('noLessors')}</p>
        </div>
      ) : (
      ...
      <Modal
        ...
        title={editing ? t('editLessor') : t('addLessor')}
        size="sm"
      >
        {formError && (
          <div className="mb-4">
