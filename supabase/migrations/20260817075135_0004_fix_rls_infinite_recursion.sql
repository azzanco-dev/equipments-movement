...
-- Problem: profiles policies query profiles itself to check admin role → infinite recursion
-- Solution: Create a SECURITY DEFINER function that reads role bypassing RLS
...
-- Also a helper to get current user's role
